...
/* ═══════════════════════════════════════════════════════════════
   CAMBIAR-AQUI-PETID
   Esta es la ÚNICA línea que debes tocar en cada mascota nueva.
   Debe ser un texto único, que no se repita con ninguna otra
   mascota (será el nombre de su carpeta en Google Drive).
   Recomendado seguir tu propio patrón: NOMBRE-INICIALES0000
   (igual que ya usas en MASCOTAS1-QR), sin espacios ni tildes.
   ═══════════════════════════════════════════════════════════════ */
  petId: "MIKI-QR0000",
/* ═══════════════════════════════════════════════════════════════
   FIN CAMBIAR-AQUI-PETID
   ═══════════════════════════════════════════════════════════════ */
